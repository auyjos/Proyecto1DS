...
class CollapsibleFrame(ttk.Frame):
    def __init__(self, parent, title, *args, **kwargs):
        ...
        self.content_grid.grid_columnconfigure(1, weight=1)
    ...
    def generate_graph(self):
        ...
        fig = Figure(figsize=(1, 2), dpi=100)
...
def create_tab_content(parent, collapsibles, nulls, statistics):
    tab_content = ttk.Frame(parent)
    ...
    for i in range(len(collapsibles)):
        ...
        collapsible.add_statistics(n, st)
...
def show_main_window(X):
    ...
    for tab_name in ["Categóricas", "Continuas", "Discretas"]:
        if tab_name == "Categóricas":
            tab_content = create_tab_content(notebook, categorical, null_values, statistics)
        elif tab_name == "Continuas":
            tab_content = create_tab_content(notebook, continuous, null_values, statistics)
        else:
            tab_content = create_tab_content(notebook, discreet, null_values, statistics)
